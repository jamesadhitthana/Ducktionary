...
public class HelpAddWordController implements Initializable {
	...
	String pathVideoAddWord = new File("src/application/helpmenu/helpgif/add new words.mp4").getAbsolutePath();
